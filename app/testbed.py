...
c.execute('''CREATE TABLE shift_reports (usergroup text, shift text, personnel text, goals text, ...
				progress text, problems text, next_shit text, brief_summary text, other text, ...
				useful_beam_time real, unscheduled_accelerator_down real, other_down_reason text, ...
				accelerator_physicist_availability real)''')
c.execute("INSERT INTO shift_reports VALUES('E201', 'Swing', 'David', fake_goals, fake_progress, ...
				fake_problems, fake_next_shift, fake_summary, "", 8, 0, 0, 100)")
