"""Remove the shifts column from ShiftReports

Revision ID: 31e6983050db
Revises: 1c0d0059ddc5
Create Date: 2015-02-25 11:41:41.021506

"""

# revision identifiers, used by Alembic.
revision = '31e6983050db'
down_revision = '1c0d0059ddc5'
...
def upgrade():
		drop_column_sqlite('shift_report', 'shifts')


def downgrade():
    op.add_column('shift_report', sa.Column('shifts', sa.String()))
